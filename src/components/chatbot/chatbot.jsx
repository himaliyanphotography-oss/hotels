...
export default function Chatbot() {
  ...
  const questions = [
    {
      key: "Welcome message",
      label: "Hi, Welcome to Spellmount Resort!, How can I help you?",
    },
    {
      key: "name",
  ...
  return (
    <>
      <div
        ...
        className="fixed bottom-8 right-8 text-white w-14 h-14 rounded-full bg-gradient-to-r  bg-green-600 hover:bg-green-700  cursor-pointer flex items-center justify-center z-50 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
      >
        {open ? (
          <X className="w-6 h-6" />
        ) : (
                ...
                <div key={idx} className="space-y-3">
                  ...
                  {idx < step && (
                    <div className="flex items-start justify-end gap-2">
                      <div className="bg-green-600 text-white p-3 rounded-lg rounded-tr-none shadow-sm max-w-[85%]">
                        <p>{formData[q.key]}</p>
                      </div>
                  ...
                  <div className="bg-white dark:bg-gray-700 p-3 rounded-lg rounded-tl-none shadow-sm max-w-[85%]">
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-300 mt-1">
                      ...
                      <span className="inline-block mt-2">
                        <strong>Please note:</strong> For calls after 6 PM, kindly use our alternate contact number: <span className="font-semibold">+918279677141</span>.
                      </span>
                    </p>
                  </div>
                </div>
            ...
            <div className="p-3 border-t border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900">
              ...
              <form onSubmit={handleNext}>
                <div className="relative">
                  ...
                  <button
                    type="submit"
                    className="absolute right-2 top-1/2 -translate-y-1/2 bg-green-600 hover:bg-green-700 text-white p-2 rounded-full transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                  >
